         ...
         {/* Giải thưởng thành tựu */}
            <div className="container mx-auto py-16 px-4">
                <div class="relative flex items-center justify-center mb-8">
                    ...
                    <h2 class="text-[#00b14f] text-3xl font-extrabold leading-[1.2] mx-9 uppercase tracking-wide">
                        Giải thưởng, thành tựu
                    </h2>

                    <div class="w-[220px] h-[5px] bg-[url('https://cdn-new.topcv.vn/unsafe/https://static.topcv.vn/v4/image/welcome/mobile-app/decorated_title_green.png')] bg-no-repeat bg-contain transform rotate-180"></div>
                </div>
                ...
                <div class="flex flex-col items-center gap-[40px]">
                            ...
                            <span class="flex flex-col h-full justify-center px-[45px] py-[20px] pl-[48px] w-full text-left">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1 text-white">
                                        ...
                                        <a href="#" class="text-sm font-medium mt-2 inline-block">
                                            Đọc thêm →
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="flex items-start justify-center gap-0">
                        ...
                        <div class="h-[149.03px] ml-[-7px] w-[323.5px]">
