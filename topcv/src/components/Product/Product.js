...
export const Product = () => {
    ...
    return (
        <>
            ...
            <a href="#" className="group relative block bg-white border border-gray-100 rounded-lg p-4 flex items-end space-x-4 
   hover:bg-[#f3f5f7] hover:border-gray-300 hover:text-green-600 transition-all duration-200">
    ...
    <div className="flex-1">
        <div className="flex items-center">
            <span className="px-2 py-0 bg-red-600 text-white rounded-full mr-1 animate-bounce">
                HOT
            </span>
