        ...
        <div class="container mx-auto">
            ...
            <div class="container mx-auto">
                <div class="flex items-center justify-between space-x-4">
                    <div class="">
                        <div class="flex items-center px-3 py-2 bg-white border border-gray-200 rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="border rounded-lg shadow-lg p-4 w-96 bg-white">
                    <div class="flex items-center space-x-4 justify-between">
                        <img src="https://cdn-new.topcv.vn/unsafe/140x/https://static.topcv.vn/company_logos/cong-ty-tnhh-kohnan-viet-nam-61949ebb1b4d7.jpg" alt="EMIR Logo" class="w-20 h-20" />
                        <div>
                            <h2 class="text-lg font-semibold text-gray-800">Chuyên Viên Cao Cấp Pháp Chế T...</h2>
                            <p class="text-gray-500">Công ty Cổ phần Tập đoàn Đầu tư EMIR</p>
                        </div>

                    </div>
                    <div class="flex justify-between items-center mt-4">
                        <span class="bg-gray-100 text-gray-700 px-2 py-1 rounded">20 - 35 triệu</span>
                        <span class="bg-gray-100 text-gray-700 px-2 py-1 rounded">Hà Nội</span>
                    </div>
                </div>
                ...
                <div class="border rounded-lg shadow-lg p-4">
                    <img src="logo3.png" alt="Kodo Logo" class="w-16 h-16 mx-auto" />
                    <h2 class="text-xl font-semibold text-center mt-2">Quản Lý Thương Hiệu</h2>
                    <p class="text-center text-gray-500">CÔNG TY TNHH DCORP TOÀN CẦU</p>
                    <div class="flex justify-between mt-2">
                        <span class="text-gray-700">Thỏa thuận</span>
                        <span class="text-gray-700">Hồ Chí Minh</span>
                    </div>
                </div>
            </div>
        </div>
