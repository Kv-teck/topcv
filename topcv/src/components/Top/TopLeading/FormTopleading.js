    ...
    return (
        <>
            <div className="bg-white border border-gray-300 rounded-2xl p-5 text-center 
                ...
                <img src="https://static.topcv.vn/company_logos/3GX73vFwKm2ouh5rDr22.jpg" alt="Company 1 Logo" className="w-40 h-40 mx-auto mt-5" />
                <h3 className="text-lg font-semibold mt-3">CÔNG TY CỔ PHẦN ĐẦU TƯ PHÁT TRIỂN MÁY VIỆT NAM</h3>
            </div>
            <div className="bg-white border border-gray-300 rounded-2xl p-5 text-center 
                hover:shadow-[6px_0_16px_rgba(34,197,94,0.2),-6px_0_16px_rgba(34,197,94,0.2)] hover:scale-103 
                hover:border-green-500 transition-all duration-300 ease-in-out">
                ...
                <img src="https://static.topcv.vn/company_logos/3GX73vFwKm2ouh5rDr22.jpg" alt="Company 1 Logo" className="w-40 h-40 mx-auto mt-5" />
                <h3 className="text-lg font-semibold mt-3">CÔNG TY CỔ PHẦN ĐẦU TƯ PHÁT TRIỂN ĐIỆN</h3>
            </div>
            <div className="bg-white border border-gray-300 rounded-2xl p-5 text-center 
                hover:shadow-[6px_0_16px_rgba(34,197,94,0.2),-6px_0_16px_rgba(34,197,94,0.2)] hover:scale-103 
                hover:border-green-500 transition-all duration-300 ease-in-out">
                ...
                <img src="https://static.topcv.vn/company_logos/3GX73vFwKm2ouh5rDr22.jpg" alt="Company 1 Logo" className="w-40 h-40 mx-auto mt-5" />
                <h3 className="text-lg font-semibold mt-3">CÔNG TY CỔ PHẦN ĐẦU TƯ PHÁT TRIỂN VIỆT NAM</h3>
            </div>
        </>
    )
}
